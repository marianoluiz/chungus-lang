...
STATES = {
    ...
    # --- Identifiers ---
    172: State({*ATOMS['all_alphabet'], '_'}, [173, 174]),
    173: State(ATOMS['under_alpha_num'], [173, 174]),
    174: State(DELIMS['id_delim'], end=True),

    # --- Numeric Literals ---
    175: State({'-'}, [176]),
    176: State(ATOMS['all_num'], [177, 178, 214]),
    177: State(DELIMS['dtype_lit_delim'], end=True),
    178: State(ATOMS['all_num'], [179, 180, 214]),
    179: State(DELIMS['dtype_lit_delim'], end=True),
    180: State(ATOMS['all_num'], [181, 182, 214]),
    181: State(DELIMS['dtype_lit_delim'], end=True),
    182: State(ATOMS['all_num'], [183, 184, 214]),
    183: State(DELIMS['dtype_lit_delim'], end=True),
    
    184: State(ATOMS['all_num'], [185, 186, 214]),
    185: State(DELIMS['dtype_lit_delim'], end=True),
    186: State(ATOMS['all_num'], [187, 188, 214]),
    187: State(DELIMS['dtype_lit_delim'], end=True),
    188: State(ATOMS['all_num'], [189, 190, 214]),
    189: State(DELIMS['dtype_lit_delim'], end=True),
    190: State(ATOMS['all_num'], [191, 192, 214]),
    191: State(DELIMS['dtype_lit_delim'], end=True),
    192: State(ATOMS['all_num'], [193, 194, 214]),
    193: State(DELIMS['dtype_lit_delim'], end=True),
    194: State(ATOMS['all_num'], [195, 196, 214]),
    195: State(DELIMS['dtype_lit_delim'], end=True),
    196: State(ATOMS['all_num'], [197, 198, 214]),
    197: State(DELIMS['dtype_lit_delim'], end=True),
    198: State(ATOMS['all_num'], [199, 200, 214]),
    199: State(DELIMS['dtype_lit_delim'], end=True),

    200: State(ATOMS['all_num'], [201, 202, 214]),
    201: State(DELIMS['dtype_lit_delim'], end=True),
    202: State(ATOMS['all_num'], [203, 204, 214]),
    203: State(DELIMS['dtype_lit_delim'], end=True),
    204: State(ATOMS['all_num'], [205, 206, 214]),
    205: State(DELIMS['dtype_lit_delim'], end=True),
    206: State(ATOMS['all_num'], [207, 208, 214]),
    207: State(DELIMS['dtype_lit_delim'], end=True),
    208: State(ATOMS['all_num'], [209, 210, 214]),
    209: State(DELIMS['dtype_lit_delim'], end=True),
    210: State(ATOMS['all_num'], [211, 212, 214]),
    211: State(DELIMS['dtype_lit_delim'], end=True),
    212: State(ATOMS['all_num'], [213, 214]),

    214: State('.', [215]),
    215: State(ATOMS['all_num'], [216, 217]),
    216: State(DELIMS['dtype_lit_delim'], end=True),
    217: State(ATOMS['all_num'], [218, 219]),
    218: State(DELIMS['dtype_lit_delim'], end=True),
    219: State(ATOMS['all_num'], [220, 221]),
    220: State(DELIMS['dtype_lit_delim'], end=True),
    221: State(ATOMS['all_num'], [222, 223]),
    222: State(DELIMS['dtype_lit_delim'], end=True),
    223: State(ATOMS['all_num'], [224, 225]),
    224: State(DELIMS['dtype_lit_delim'], end=True),
    225: State(ATOMS['all_num'], [226]),
    226: State(DELIMS['dtype_lit_delim'], end=True),

    # --- String Literals ---
    227: State("'", [228, 229]),
    228: State(ATOMS['string_ascii'], [228, 229]),
    229: State("'", [230]),
    230: State(DELIMS['stmt_delim'], end=True)
}